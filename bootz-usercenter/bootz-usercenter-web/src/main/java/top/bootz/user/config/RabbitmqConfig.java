...
public class RabbitmqConfig {
	...
	@Bean
	public Binding bindPingQueueToDirectExchange(Queue pingQueue, DirectExchange directExchange) {
	...
	@Bean
	public Binding bindUpdateAuthQueueToDirectExchange(Queue updateAuthQueue, DirectExchange directExchange) {
