...
import static top.bootz.user.commons.constants.RabbitConstants.Exchange;
import static top.bootz.user.commons.constants.RabbitConstants.RoutingKey;
...
public class PingController extends BaseController {
    ...
    public @ResponseBody
    ResponseEntity<RestMessage> ping(HttpServletRequest request) throws InterruptedException {
    ...
    private boolean testRabbitmq() throws InterruptedException {
        ...
        Long messageId = pingMessageSender.send(Exchange.DIRECT, RoutingKey.UC_DIRECT_PING, message, MapHelper.emptyMap());
        Thread.sleep(2000);
