...
public class UserController extends UserBaseController {
	...
	public ResponseEntity<String> add(HttpServletRequest request, @RequestBody User4Add user4Add) throws Exception {
		User user = new User();
		...
		return buildCreateSuccessResponse(buildLocation(request, user.getId()));
	}
